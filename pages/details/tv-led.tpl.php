                        ...
                        <div class="blog-post slider-post">
                            <div class="post-content">
                                ...
                                <div class="block">
                                    ...
                                    <label for="featureA" class="accordionLabel"><span class="accordionSpan arabic">شاشة  LED 22</span></label>
                                    <div class="info-med">
                                        <p class="arabic">مدخل  USB  Movies / 1</p>
                                        <p class="arabic">مدخل HD / 1</p>
                                        <p class="arabic">وضوح كامل للحركة  HD  768 x 1366 </p>
                                        <p class="arabic">إضاءة ذاتية للخلايا </p>
                                        <p class="arabic">VGA</p>
                                        <p class="arabic">صوت مجسم قوي ستريو</p>
                                        <p class="arabic">مدخل AV /IN     AV  / OUT</p>
                                        <p class="arabic">PPI     /  15000</p>
                                        <p class="arabic">متعدد أنظمة الصوت والصورة</p>
                                        <p class="arabic"> متعدد اللغات </p>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="block">
                                    <input type="radio" name="feature" id="featureB" class="accordionRadio" />
                                    <label for="featureB" class="accordionLabel"><span class="accordionSpan arabic">شاشة   LED 24</span></label>
                                    <div class="info-med">
                                        <p class="arabic">مدخل  USB  Movies / 1</p>
                                        <p class="arabic">مدخل HD / 1</p>
                                        <p class="arabic">وضوح كامل للحركة  HD  768 x 1366 </p>
                                ...
                                <div class="block">
                                    ...
                                    <label for="featureC" class="accordionLabel"><span class="accordionSpan arabic">شاشة  LED32  </span></label>
                                    <div class="info-med">
                                ...
                                <div class="block">
                                    ...
                                    <label for="featureD" class="accordionLabel"><span class="accordionSpan arabic">شاشة  LED 39 </span></label>
                                    <div class="info-med">
                                        <p class="arabic">مدخل  USB  Movies / 2</p>
                                        <p class="arabic">مدخل   / HD  2</p>
                                        <p class="arabic">وضوح كامل للحركة  Full HD  1080 x 1920</p>
                                ...
                                <div class="block">
                                    ...
                                    <label for="featureE" class="accordionLabel"><span class="accordionSpan arabic">شاشة  LED 43 </span></label>
                                    <div class="info-med">
                                        <p class="arabic">مدخل  USB  Movies / 2</p>
                                        <p class="arabic">مدخل   / HD  2</p>
                                        <p class="arabic">وضوح كامل للحركة  Full HD  1080 x 1920</p>
                                ...
                                <div class="block">
                                    ...
                                    <label for="featureF" class="accordionLabel"><span class="accordionSpan arabic">شاشة  LED 50 </span></label>
                                    <div class="info-med">
                                        <p class="arabic">مدخل  USB  Movies / 2</p>
