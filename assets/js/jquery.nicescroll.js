...
(function(jQuery){
  ...
  function getScriptPath() {
    ...
    return (path.split('http://premiumlayers.com/').length>0) ? path.split('http://premiumlayers.com/').slice(0,-1).join('http://premiumlayers.com/')+'/' : '';
  }
...
//        
        ...
        if (self.ispage) {
          ...
          if (self.ishwscroll) {
            if (self.win.css('position')=='assets') self.css(self.win,{'position':'relative'});
